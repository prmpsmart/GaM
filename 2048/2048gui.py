...
class PRMP_Game(Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.highscorestring.set("0")
        self.create_widgets()
        # self.canvas = tk.Canvas(self.container, width=410, height=410, borderwidth=5, highlightthickness=0)
        self.canvas = Canvas(self.container, config=dict(width=410, height=410, borderwidth=5, highlightthickness=0), )
        self.canvas.pack(side="top", fill="both", expand="false")
        self.new_game()
        self.mainloop()
