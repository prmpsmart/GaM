...
#    Dec 18, 2020 06:50:52 PM WAT  platform: Windows NT
...
import object_details_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    object_details_support.set_Tk_var()
    top = DCObjDetails (root)
    object_details_support.init(root, top)
    root.mainloop()

w = None
def create_DCObjDetails(root, *args, **kwargs):
    ...
    object_details_support.set_Tk_var()
    top = DCObjDetails (w)
    object_details_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_DCObjDetails():
    global w
    w.destroy()
    w = None
