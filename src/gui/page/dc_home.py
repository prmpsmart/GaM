...
#    Dec 17, 2020 06:26:21 PM WAT  platform: Windows NT
...
class DCHome:
    def __init__(self, top=None):
        ...
        self.Label1_3 = tk.Label(self.Labelframe1_1)
        self.Label1_3.place(relx=0.016, rely=0.316, height=23, width=123
                , bordermode='ignore')
        self.Label1_3.configure(activebackground="#f9f9f9")
        self.Label1_3.configure(activeforeground="black")
        self.Label1_3.configure(background="#d9d9d9")
        ...
        self.Label1_3.configure(highlightcolor="black")
        self.Label1_3.configure(relief="groove")
        self.Label1_3.configure(text='''Persons''')

        self.Label1_4 = tk.Label(self.Labelframe1_1)
        self.Label1_4.place(relx=0.016, rely=0.632, height=23, width=123
                , bordermode='ignore')
        ...
        self.Label1_4.configure(text='''Total Subs''')

        self.Label1_3 = tk.Label(self.Labelframe1_1)
        self.Label1_3.place(relx=0.22, rely=0.316, height=24, width=63
                , bordermode='ignore')
        self.Label1_3.configure(activebackground="#f9f9f9")
        self.Label1_3.configure(activeforeground="black")
        self.Label1_3.configure(background="#d9d9d9")
        ...
        self.Label1_3.configure(text='''6''')

        self.Label1_5 = tk.Label(self.Labelframe1_1)
        self.Label1_5.place(relx=0.346, rely=0.632, height=23, width=123
                , bordermode='ignore')
        ...
        self.Label1_5.configure(text='''Active Accounts''')

        self.Label1_3 = tk.Label(self.Labelframe1_1)
        self.Label1_3.place(relx=0.551, rely=0.632, height=24, width=63
                , bordermode='ignore')
        self.Label1_3.configure(activebackground="#f9f9f9")
        self.Label1_3.configure(activeforeground="black")
        self.Label1_3.configure(background="#d9d9d9")
        ...
        self.Label1_4 = tk.Label(self.Labelframe1_1)
        self.Label1_4.place(relx=0.677, rely=0.316, height=23, width=123
                , bordermode='ignore')
        self.Label1_4.configure(activebackground="#f9f9f9")
        self.Label1_4.configure(activeforeground="black")
        self.Label1_4.configure(background="#d9d9d9")
        ...
        self.Label1_4.configure(highlightcolor="black")
        self.Label1_4.configure(relief="groove")
        self.Label1_4.configure(text='''Total Accounts''')

        self.Label1_4 = tk.Label(self.Labelframe1_1)
        self.Label1_4.place(relx=0.882, rely=0.316, height=24, width=63
                , bordermode='ignore')
        self.Label1_4.configure(activebackground="#f9f9f9")
        self.Label1_4.configure(activeforeground="black")
        self.Label1_4.configure(background="#d9d9d9")
        ...
        self.Label1_4.configure(text='''60''')

        self.Button3 = tk.Button(self.Labelframe1_1)
        self.Button3.place(relx=0.795, rely=0.632, height=28, width=119
                , bordermode='ignore')
        self.Button3.configure(activebackground="#ececec")
        self.Button3.configure(activeforeground="#000000")
        self.Button3.configure(background="#d9d9d9")
        self.Button3.configure(disabledforeground="#a3a3a3")
        self.Button3.configure(font="-family {Times New Roman} -size 11 -weight bold")
        self.Button3.configure(foreground="#000000")
        self.Button3.configure(highlightbackground="#d9d9d9")
        self.Button3.configure(highlightcolor="black")
        self.Button3.configure(pady="0")
        self.Button3.configure(relief="groove")
        self.Button3.configure(text='''Object Details''')
